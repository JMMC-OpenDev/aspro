 ...
 * {@link XYPlot}.
 */
public class ExtendedXYTextAnnotation extends AbstractXYAnnotation
     ...
     */
    public ExtendedXYTextAnnotation(String text, double x, double y) {
        if (text == null) {
        ...
        // avoid creating useless stroke:
        // this.outlineStroke = new BasicStroke(0.5f);
        this.outlineStroke = ChartUtils.THIN_STROKE;
    }
    ...
    public void draw(final Graphics2D g2, final XYPlot plot, final Rectangle2D dataArea,
        ...
        g2.setFont(getFont());
        final Shape hotspot = TextUtils.calculateRotatedStringBounds(
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExtendedXYTextAnnotation)) {
            return false;
        }
        ExtendedXYTextAnnotation that = (ExtendedXYTextAnnotation) obj;
