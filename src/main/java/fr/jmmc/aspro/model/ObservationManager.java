...
public final class ObservationManager extends BaseOIManager implements Observer {
    ...
    /**
     * This fires an observation targets change event to all registered listeners.
    ...
    public static void validateOrPrepareUserModel(final ObservationSetting observation, final UserModel userModel,
        ...
        synchronized (userModel) {
            ...
            double lambdaMax = Double.NaN;

            final FocalInstrument instrument;
            ...
            if (instrumentChoice != null) {
                ...
                instrument = instrumentChoice.getInstrumentConfiguration().getFocalInstrument();

                // use lower/upper wavelength of all instrument modes:
                lambdaMin = AsproConstants.MICRO_METER * instrument.getWaveLengthMin();
                lambdaMax = AsproConstants.MICRO_METER * instrument.getWaveLengthMax();
            } else {
                instrument = null;
            }
            ...
            if (reload || !UserModelService.checkAiryRadius(userModel, params)) {
                logger.debug("validateOrPrepareUserModel: prepare model ...");

                // throws exceptions if the given fits file or image is incorrect:
                UserModelService.prepareUserModel(userModel, params);
