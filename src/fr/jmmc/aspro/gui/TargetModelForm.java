 ...
 * JMMC project
 *
 * "@(#) $Id: TargetModelForm.java,v 1.18 2010-05-19 12:04:10 mella Exp $"
 *
 * History
 * -------
...
public class TargetModelForm extends javax.swing.JPanel implements ActionListener, TreeSelectionListener, ListSelectionListener {
    ...
    public TargetModelForm() {
        ...
        boolean preferXyMode = prefs.getPreferenceAsBoolean(Preferences.MODELEDITOR_PREFERXY);
        if (preferXyMode) {
    ...
    private void initComponents() {
        ...
        jTableModelParameters = new fr.jmmc.mcs.gui.NumericJTable();
