...
-->
    ...
    <xsl:variable name="DEC_index">
      ...
      <xsl:comment>RA_index: <xsl:value-of select="$RA_index"/></xsl:comment>
      <xsl:comment>DEC_index: <xsl:value-of select="$DEC_index"/></xsl:comment>
...
<!-- starting output document -->
  ...
  -->          
      ...
      <xsl:comment>RA: <xsl:value-of select="$RA"/></xsl:comment>
      <xsl:comment>DEC: <xsl:value-of select="$DEC"/></xsl:comment>
