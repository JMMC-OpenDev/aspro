...
stilts plot2plane \
   ...
   xmin=1 xmax=14 ymin=0 ymax=200 \
   ...
   layer_2=Line \
      ...
      leglabel_2=MACAO \
   layer_3=Mark \
      in_3=VLTI_UT_GRAVITY_FT_GPAO.csv \
      x_3=K_mag y_3=SNR_FT \
      color_3=blue \
      leglabel_3=GPAO \
   layer_4=Line \
      in_4=VLTI_UT_GRAVITY_FT_GPAO.csv \
      x_4=K_mag y_4=SNR_FT \
      color_4=blue thick_4=2 \
      leglabel_4=GPAO \
   layer_5=Function \
      fexpr_5=3 color_5=green \
      leglabel_5='SNR=3' 
