...
public final class DualPivotQuicksort {
     ...
     */
    private static final int MIN_PARALLEL_PART_MERGE_SIZE = 4 << 10;
     ...
     */
    public static void sort(int[] a, int processors, int low, int high) {
        int size = high - low;

        if (size > MIN_PARALLEL_SORT_SIZE && processors > 1) {
...
// [long]
     ...
     * @param high the index of the last element, exclusive, to be sorted
     */
    public static void sort(long[] a, int processors, int low, int high) {
        int size = high - low;
...
// [byte]
    ...
    private static void countingSort(byte[] a, int low, int high) {
        ...
        for (int i = NUM_BYTE_VALUES, k = high; k > low; ) {
            ...
            for (int c = count[i]; --c >= 0; a[--k] = value);
        }
    }
...
// [float]
     ...
     * @param high the index of the last element, exclusive, to be sorted
     */
    public static void sort(float[] a, int processors, int low, int high) {
        /*
...
// [double]
     ...
     * @param high the index of the last element, exclusive, to be sorted
     */
    public static void sort(double[] a, int processors, int low, int high) {
        /*
...
// [class]
    ...
    private static final class Sorter extends CountedCompleter<Void> {
        ...
        private Sorter(CountedCompleter<?> completer,
    ...
    private static final class Merger extends CountedCompleter<Void> {
        ...
        private Merger(CountedCompleter<?> completer, Object dst, int k,
     ...
     */
    private static int getDepth(int size, int processors) {
        int depth = 0;

        while ((size >>= 2) > MIN_PARALLEL_SORT_SIZE && (processors >>= 3) > 0) {
            depth -= 2;
        }
        return depth;
    }
