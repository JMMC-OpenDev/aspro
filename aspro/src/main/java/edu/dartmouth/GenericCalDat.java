...
public final class GenericCalDat implements Cloneable {
    ...
    /**
     * LBO: updater to avoid creating too much instances
     * @param jdin
     */
    public GenericCalDat update(final double jdin) {
        calFromJD(jdin);
        return this;
    }
    ...
    void calFromJD(final double jd) {
        ...
        while (!rounded_ok) {
            ...
            B = A + 1524l;
            C = (long) ((B - 122.1d) * Const.DAY_IN_YEAR);
            D = (long) (365.25d * C);
            E = (long) ((B - D) / 30.6001d);
            ...
            timeofday = (timeofday == null) ? new Sexagesimal(24d * F) : timeofday.update(24d * F);
    ...
    double cal2JD() {
        ...
        final double jdout = (long) (365.25d * (double) y) + (long) (30.6001d * (m + 1)) + day
                + 1720994.5d
                + (double) timeofday.hour * Const.HOUR_IN_DAY + (double) timeofday.minute / 1440d
